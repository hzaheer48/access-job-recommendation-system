        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={stat.name} className={`group relative bg-gradient-to-br ${color.bg} dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 hover:shadow-large transition-all duration-300 hover:-translate-y-1 border ${color.border} dark:border-gray-600/30`}>
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">{stat.name}</h3>
              ...
              {recommendations.length > 0 ? (
                <div className="space-y-4">
                  {recommendations.map((recommendation) => (
                    <div key={recommendation.job.id} className="group relative bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-xl p-5 hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
                      ...
                      <div className="relative">
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex-1">
                            <h4 className="text-base font-semibold text-gray-900 dark:text-white group-hover:text-primary-700 dark:group-hover:text-primary-300 transition-colors">{recommendation.job.title}</h4>
                            <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">{recommendation.job.company}</p>
                        ...
                        {/* AI Explanation */}
                        <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-700/50">
                          <p className="text-xs text-blue-800 dark:text-blue-300 font-medium mb-1">Why this job matches:</p>
                        ...
                        <div className="pt-3 border-t border-gray-100 dark:border-gray-700">
                          <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Was this recommendation helpful?</p>
                ...
                <div className="text-center py-8">
                  <p className="text-gray-500 dark:text-gray-400 mb-4">No recommendations available. Complete your profile to get personalized job suggestions.</p>
                  <Link
                    to="/profile"
                ...
                {recentApplications.length > 0 ? (
                  <div className="space-y-4">
                    {recentApplications.map((application) => (
                      <div key={application.id} className="group relative bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-xl p-5 hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div className="relative">
                          <div className="flex justify-between items-start mb-3">
                            <div className="flex-1">
                              <h4 className="text-base font-semibold text-gray-900 dark:text-white group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors">{application.job.title}</h4>
                              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">{application.job.company}</p>
                            </div>
                            <div className="flex items-center">
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
                          ...
                          {application.status === 'interview_scheduled' && (
                            <div className="mt-3 p-3 bg-success-50 dark:bg-success-900/30 rounded-lg border border-success-200 dark:border-success-700/50">
                              <p className="text-xs text-success-700 dark:text-success-300 font-medium flex items-center">
                                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500 dark:text-gray-400 mb-4">No applications yet. Start applying to jobs!</p>
                    <Link
                      to="/jobs"
                      className="btn-primary text-sm px-6 py-2"
                    >
            ...
            <div className="card-glass backdrop-blur-sm border border-white/20 dark:border-gray-700/30">
              <div className="px-6 py-6 sm:p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link
                    to="/jobs"
                    className="group relative bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-xl p-4 hover:shadow-medium transition-all duration-300 hover:-translate-y-1 flex items-center justify-center text-sm font-medium text-gray-700 dark:text-gray-300"
                  >
